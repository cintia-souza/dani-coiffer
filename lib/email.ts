...
const FROM_EMAIL = 'Dany Diniz <noreply@danydiniz.com.br>'
...
export async function sendReminder24h(data: ReminderData) {
  ...
  await resend.emails.send({
    from: FROM_EMAIL,
    to: data.clientEmail,
    subject: `💇 Lembrete: Seu horário amanhã na Dany Diniz`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #b76e79; margin-bottom: 5px;">Dany Diniz</h2>
        ...
        <div style="background: #fef7f7; border-radius: 12px; padding: 16px; margin: 16px 0;">
        ...
        <div style="text-align: center; margin: 24px 0;">
          <a href="${confirmUrl}" style="display: inline-block; background: #b76e79; color: white; padding: 12px 32px; border-radius: 50px; text-decoration: none; font-weight: bold; margin-right: 8px;">
            ✓ Vou comparecer
          </a>
          <a href="${cancelUrl}" style="display: inline-block; background: #fff; color: #b76e79; padding: 12px 32px; border-radius: 50px; text-decoration: none; font-weight: bold; border: 2px solid #b76e79;">
            ✕ Preciso cancelar
          </a>
        </div>
        ...
        <p style="font-size: 12px; color: #999; text-align: center;">
          Dany Diniz — R. Fernanda, 19 — Jardim Barueri, SP
        </p>
      </div>
    `,
  })
...
export async function sendReminder2h(data: ReminderData) {
  ...
  await resend.emails.send({
    from: FROM_EMAIL,
    to: data.clientEmail,
    subject: `⏰ Faltam 2h para seu horário na Dany Diniz!`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #b76e79; margin-bottom: 5px;">Dany Diniz</h2>
        ...
        <p style="font-size: 14px; color: #555;">📍 Estamos te esperando na <strong>R. Fernanda, 19 — Jardim Barueri</strong></p>

        <p style="font-size: 13px; color: #888; margin-top: 20px;">Até já! 💖</p>

        <hr style="border: none; border-top: 1px solid #fce7f3; margin: 20px 0;" />
        <p style="font-size: 12px; color: #999; text-align: center;">
          Dany Diniz — Salão de Beleza em Barueri
        </p>
      </div>
    `,
  })
